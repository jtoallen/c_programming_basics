...
/*
The char array automatically adds the null character at the end of a string.
It must be accounted for when allocating memory.
So, allocate memory for length of char array PLUS 1
*/
...
// int main()
// {
//     char input[64]; // holds 63 characters PLUS 1 for the \0 character, null character
//     int len;
...
//     char buffer[128]; // var used to append second str to first str
